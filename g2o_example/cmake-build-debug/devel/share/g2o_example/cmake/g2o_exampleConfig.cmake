...
if(g2o_example_CONFIG_INCLUDED)
  return()
endif()
set(g2o_example_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(g2o_example_SOURCE_PREFIX /home/huyh/distributed_mapper_ws/src/g2o_example)
  set(g2o_example_DEVEL_PREFIX /home/huyh/distributed_mapper_ws/src/g2o_example/cmake-build-debug/devel)
  set(g2o_example_INSTALL_PREFIX "")
  set(g2o_example_PREFIX ${g2o_example_DEVEL_PREFIX})
else()
  set(g2o_example_SOURCE_PREFIX "")
  set(g2o_example_DEVEL_PREFIX "")
  set(g2o_example_INSTALL_PREFIX /usr/local)
  set(g2o_example_PREFIX ${g2o_example_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'g2o_example' is deprecated")
...
set(g2o_example_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/huyh/distributed_mapper_ws/src/g2o_example/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/jsoncpp;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/tcl;/opt/ros/kinetic/include/opencv-3.2.0-dev;/opt/ros/kinetic/include/opencv-3.2.0-dev/opencv " STREQUAL " ")
  set(g2o_example_INCLUDE_DIRS "")
  set(_include_dirs "/home/huyh/distributed_mapper_ws/src/g2o_example/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/jsoncpp;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/tcl;/opt/ros/kinetic/include/opencv-3.2.0-dev;/opt/ros/kinetic/include/opencv-3.2.0-dev/opencv")
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${g2o_example_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'g2o_example' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'junwangcas <junwangcas@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'g2o_example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/huyh/distributed_mapper_ws/src/g2o_example/${idir}'.  Ask the maintainer 'junwangcas <junwangcas@todo.todo>' to fix it.")
    endif()
    _list_append_unique(g2o_example_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND g2o_example_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/huyh/distributed_mapper_ws/src/g2o_example/cmake-build-debug/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(g2o_example_LIBRARY_DIRS ${lib_path})
      list(APPEND g2o_example_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'g2o_example'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND g2o_example_LIBRARIES ${lib})
    endif()
  endif()
...
set(g2o_example_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${g2o_example_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 g2o_example_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${g2o_example_dep}_FOUND)
      find_package(${g2o_example_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${g2o_example_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(g2o_example_INCLUDE_DIRS ${${g2o_example_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(g2o_example_LIBRARIES ${g2o_example_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${g2o_example_dep}_LIBRARIES})
  _list_append_deduplicate(g2o_example_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(g2o_example_LIBRARIES ${g2o_example_LIBRARIES})

  _list_append_unique(g2o_example_LIBRARY_DIRS ${${g2o_example_dep}_LIBRARY_DIRS})
  list(APPEND g2o_example_EXPORTED_TARGETS ${${g2o_example_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${g2o_example_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
